        ...
        {activeTab === 'flights' ? (
          <div className="flex flex-col space-y-5">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-5 border-t border-purple-50">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 ml-auto w-full sm:w-auto justify-end">
                {tripType === 'multi-city' && (
                  <TravellersSelect
                    adultsCount={adultsCount}
                    setAdultsCount={setAdultsCount}
                    ...
                    infantsCount={infantsCount}
                    setInfantsCount={setInfantsCount}
                    className="w-full sm:w-56 text-left shrink-0 py-2.5"
                  />
                )}
